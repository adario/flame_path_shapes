...
class JoystickAdvancedExample extends FlameGame with HasCollisionDetection {
  ...
  Future<void> onLoad() async {
    ...
    final flipButton = HudButtonComponent(
      button: SpriteComponent(sprite: sheet.getSpriteById(2), size: buttonSize),
      buttonDown: SpriteComponent(
        sprite: sheet.getSpriteById(4),
        size: buttonSize,
      ),
      margin: const EdgeInsets.only(right: 80, bottom: 60),
    ...
    final flopButton = HudButtonComponent(
      button: SpriteComponent(sprite: sheet.getSpriteById(3), size: buttonSize),
      buttonDown: SpriteComponent(
        sprite: sheet.getSpriteById(5),
        size: buttonSize,
      ),
      margin: const EdgeInsets.only(right: 160, bottom: 60),
    ...
    final shapeButton = HudButtonComponent(
      ...
      margin: const EdgeInsets.only(right: 85, bottom: 150),
    ...
    speedText = TextComponent(text: 'Speed: 0', textRenderer: regular);
