...
class LayoutDemo2 extends LinearLayoutComponent {
  ...
  FutureOr<void> onLoad() {
    super.onLoad();
    addAll(createLayoutChildren(direction: direction));
  }
  ...
  static List<Component> createLayoutChildren({required Direction direction}) {
    return [
      ExpandedComponent(
        child: RectangleComponent(paint: Paint()..color = Colors.purple),
      ),
      LinearLayoutComponent.fromDirection(
        ...
        children: [TextComponent(text: 'test')],
      ),
    ];
  }
}
