...
class LayoutComponentExample3 extends FlameGame with DragCallbacks {
  LayoutComponentExample3({required this.demoSize});
  ...
  FutureOr<void> onLoad() {
    ...
    final rootColumnComponent = ColumnComponent(
      ...
      children: [
        ...
        LayoutDemo3(position: Vector2.zero(), size: demoSize.toVector2()),
      ],
    );
...
class LayoutDemo3 extends ColumnComponent {
  LayoutDemo3({required super.position, super.size, super.key})
    : super(
  ...
  FutureOr<void> onLoad() {
    super.onLoad();
    addAll([
      TextBoxComponent(text: sampleText),
      TextBoxComponent(text: sampleText),
    ]);
  }
